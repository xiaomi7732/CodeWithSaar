...
namespace JWT.Example.WithSQLDB
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            JWTAuthOptions authOptions = Configuration
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "JWT.Example.WithSQLDB", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "JWT.Example.WithSQLDB v1"));
            }
