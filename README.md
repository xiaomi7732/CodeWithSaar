...
* [Learn Blazor Routing and Navigation by building fishcard &#124; .NET fullstack dev - 002](https://youtu.be/4B87xqF1re0)
...
* 8/31/2022: [The clock](https://clock.codewithsaar.net) - HTML/JS PWA clock application
...
* [The Clock](https://clock.codewithsaar.net) - A PWA clock app with second on it - [source code](https://github.com/xiaomi7732/jsClock)

  [![Clock screenshot](./images/ProjectClock.png)](https://clock.codewithsaar.net)

* [Fishcard](https://fishcard.codewithsaar.net) - Search what fish to eat while pregnant - Blazor Web Assembly.

  [<img src="./images/project_fishcard.png" width="550" alt="Fishcard screenshot" />](https://fishcard.codewithsaar.net)
...
* Stack Beauty
  ...
  * [Live Site](stack.codewithsaar.net)
    ...
    [<img src="./images/project_stack.png" width="550" alt="StackBeauty screenshot" />](https://stack.codewithsaar.net)
